...
/**
 * Jersey REST client generated for REST resource:MantenimientoFacadeREST
 * [mantenimiento]<br>
 * USAGE:
 * <pre>
...
public class MantenimientoRestFull implements MantenimientoManager{
    ...
    public void edit_XML(Object requestEntity, String id) throws WebApplicationException {
        webTarget.path(java.text.MessageFormat.format("{0}", new Object[]{id})).request(javax.ws.rs.core.MediaType.APPLICATION_XML).put(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.APPLICATION_XML), Mantenimiento.class);
    }
    ...
    public void remove(String id) throws WebApplicationException {
        webTarget.path(java.text.MessageFormat.format("{0}", new Object[]{id})).request().delete(Mantenimiento.class);
    }
