            ...
            try {
                ...
                try {
                    ...
                    if (personaLogIn instanceof Usuario) {
                        ...
                        // Si la persona es un Trabajador, cargar la vista correspondiente
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("/vistas/NavegacionPrincipalTrabajador.fxml"));
                        Parent root = loader.load();

                        ScrollPane scrollPane = new ScrollPane();
                        scrollPane.setContent(root);  // Asignar el contenido de la vista

                        // Desactivar desplazamiento horizontal
                        ...
                        // Controlador para la vista de Trabajador
